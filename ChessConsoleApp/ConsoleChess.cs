...
namespace ChessConsoleApp
{
    class ChessConsoleApp
    {
        public static Game SetUp()
        {
			...
			board[0, 3] = new BombAssassin() { Color = Color.White, Location = new Vector(0, 3) };
			board[7, 4] = new King() { Color = Color.Black, Location = new Vector(7, 4) };
			board[7, 3] = new BombAssassin() { Color = Color.Black, Location = new Vector(7, 3) };
			...
			Game.Players.Enqueue(new Murderer() { Name = "player2", Color = Color.Black });
